...
/**
 * Displays a value as its default widget type on Shuffleboard. Provides no
...
public @interface Log {
  /**
   * @return The name of the value on Shuffleboard; defaults to field or method
   *         name.
   */
  String name() default "NO_NAME";

  /**
   * @return The name of the tab in which to place this widget, if the default
   *         inferred tab/layout
   *         is not desired. Users should be careful to avoid namespace collisions
   *         if the default tab is
   *         not used. Note that Log and config annotations can be repeated to
   *         place widgets on multiple
   *         tabs. Note also that this feature is NOT currently supported for
   *         NT-only mode!
   */
  String tabName() default "DEFAULT";

  /**
   * @return Optional name of a method to call on the field (or return value of
   *         the method) to
   *         obtain the actual value that will be logged. Useful if one does not
   *         desire to make an
  ...
  /**
   * @return The row in which this widget should be placed. WARNING: If
   *         position/size is specified
   *         for one widget in an object, it should be specified for all widgets
   *         in that object to avoid
   *         overlaps.
   */
  int rowIndex() default -1;

  /**
   * @return The column in which this widget should be placed. WARNING: If
   *         position/size is
   *         specified for one widget in an object, it should be specified for all
   *         widgets in that
  ...
  /**
   * @return The width of this widget. WARNING: If position/size is specified for
   *         one widget in an
   *         object, it should be specified for all widgets in that object to
   *         avoid overlaps.
   */
  int width() default -1;

  /**
   * @return The height of this widget. WARNING: If position/size is specified for
   *         one widget in an
   *         object, it should be specified for all widgets in that object to
   *         avoid overlaps.
   */
   ...
   * <td>Number</td>
   * <td>-1.0</td>
   * <td>The minimum value of the bar</td>
   * </tr>
   * <tr>
   * <td>Max</td>
   * <td>Number</td>
   * <td>1.0</td>
   * <td>The maximum value of the bar</td>
   * </tr>
   * <tr>
   * <td>Center</td>
   * <td>Number</td>
   * <td>0</td>
   * <td>The center ("zero") value of the bar</td>
   * </tr>
   * </table>
   */
  ...
  @interface NumberBar {
     ...
     *         is not desired. Users should be careful to avoid namespace collisions
     *         if the default tab
     *         is not used. Note that Log and config annotations can be repeated to
     *         place widgets on
     *         multiple tabs. Note also that this feature is NOT currently supported
     *         for NT-only mode!
     */
    String tabName() default "DEFAULT";
     ...
     * @return The height of this widget. WARNING: If position/size is specified for
     *         one widget in
     *         an object, it should be specified for all widgets in that object to
     *         avoid overlaps.
     */
    int height() default -1;
  }
  ...
  /**
   * Displays a number with a view-only dial. Displayed values are rounded to the
   * nearest integer.
   * <br>
   * Supported types:
   *
   ...
   * <td>Number</td>
   * <td>0</td>
   * <td>The minimum value of the dial</td>
   * </tr>
   * <tr>
   * <td>Max</td>
   * <td>Number</td>
   * <td>100</td>
   * <td>The maximum value of the dial</td>
   * </tr>
   * <tr>
   * <td>Show value</td>
   * <td>Boolean</td>
   * <td>true</td>
   * <td>Whether or not to show the value as text</td>
   * </tr>
   * </table>
   */
   ...
   * on the computer
   * running the dashboard. Keep the number of visible data points to a minimum.
   * Making the widget
   * smaller also helps with performance, but may cause the graph to become
   ...
   * <td>Number</td>
   * <td>30</td>
   * <td>How long, in seconds, should past data be visible for</td>
   * </tr>
   * </table>
   */
   ...
   * </tr>
   * <tr>
   * <td>Color when false</td>
   * <td>Color</td>
   * <td>"red"</td>
   * <td>Can be specified as a string or a number</td>
   * </tr>
   * </table>
   */
   ...
   * <td>String</td>
   * <td>"HORIZONTAL"</td>
   * <td>The orientation of the bar. One of
   * {@code ["HORIZONTAL", "VERTICAL"]}</td>
   * </tr>
   * <tr>
   * <td>Number of tick marks</td>
   * <td>Number</td>
   * <td>5</td>
   * <td>The number of discrete ticks on the bar</td>
   * </tr>
   * </table>
   */
  ...
  /**
   * Displays a {@link edu.wpi.first.wpilibj.PowerDistribution
   * PowerDistributionPanel}. <br>
   * Supported types:
   *
   * <ul>
   ...
   * </tr>
   * <tr>
   * <td>Show voltage and current values</td>
   * <td>Boolean</td>
   * <td>true</td>
   * <td>Whether or not to display the voltage and current draw</td>
   * </tr>
   * </table>
   */
  ...
  /**
   * Displays an {@link edu.wpi.first.wpilibj.Encoder} displaying its speed, total
   * travelled
  ...
  /**
   * Displays a {@link edu.wpi.first.wpilibj.motorcontrol.MotorController
   * MotorController}. The speed controller
   * will be controllable from the dashboard when test mode is enabled, but will
   * otherwise be
   * view-only. <br>
   * Supported types:
   *
   ...
   * <td>String</td>
   * <td>"HORIZONTAL"</td>
   * <td>One of {@code ["HORIZONTAL", "VERTICAL"]}</td>
   * </tr>
   * </table>
   */
   ...
   * <td>Number</td>
   * <td>-1</td>
   * <td>The minimum acceleration value to display</td>
   * </tr>
   * <tr>
   * <td>Max</td>
   * <td>Number</td>
   * <td>1</td>
   * <td>The maximum acceleration value to display</td>
   * </tr>
   * <tr>
   * <td>Show text</td>
   * <td>Boolean</td>
   * <td>true</td>
   * <td>Show or hide the acceleration values</td>
   * </tr>
   * <tr>
   * <td>Precision</td>
   * <td>Number</td>
   * <td>2</td>
   * <td>How many numbers to display after the decimal point</td>
   * </tr>
   * <tr>
   * <td>Show tick marks</td>
   * <td>Boolean</td>
   * <td>false</td>
   * <td>Show or hide the tick marks on the number bars</td>
   * </tr>
   * </table>
   */
   ...
   * <tr>
   * <td>Range</td>
   * <td>{@link edu.wpi.first.wpilibj.interfaces.Accelerometer.Range}</td>
   * <td>k16G</td>
   * <td>The accelerometer range</td>
   * </tr>
   * <tr>
   * <td>Show value</td>
   * <td>Boolean</td>
   ...
   * <td>Number</td>
   * <td>180</td>
   * <td>How far to rotate the entire dial, in degrees</td>
   * </tr>
   * <tr>
   * <td>Show tick mark ring</td>
   * <td>Boolean</td>
   * <td>true</td>
   * </tr>
   * </table>
   ...
   * side of the
   * drivebase and a vector for the direction and rotation of the drivebase. The
   * widget will be
   ...
   * <td>Number</td>
   * <td>4</td>
   * <td>Must be a positive even integer
   * </td>
   * </tr>
   * <tr>
   ...
   * and vectors for
   * the direction and rotation of the drivebase. The widget will be controllable
   * if the robot is in
   * test mode. <br>
   * Supported types:
   *
   ...
   * <td>Boolean</td>
   * <td>true</td>
   * <td>Show or hide a crosshair on the image</td>
   * </tr>
   * <tr>
   * <td>Crosshair color</td>
   * <td>Color</td>
   * <td>"white"</td>
   * <td>Can be a string or a rgba integer</td>
   * </tr>
   * <tr>
   * <td>Show controls</td>
   * <td>Boolean</td>
   * <td>true</td>
   * <td>Show or hide the stream controls
   * </td>
   * </tr>
   * <tr>
   * <td>Rotation</td>
   * <td>String</td>
   * <td>"NONE"</td>
   * <td>Rotates the displayed image. One of
   * {@code ["NONE", "QUARTER_CW", "QUARTER_CCW", "HALF"]}
   * </td>
   * </tr>
   * </table>
   */
  ...
  @interface CameraStream {
    ...
    /**
     * @return Rotate the displayed image. Must be one of: "NONE", "QUARTER_CW",
     *         "QUARTER_CCW",
     *         "HALF".
     */
  ...
  /**
   * Logs an object as the value returned by its toString method. Useful for
   * logging object types
   * not natively supported by Shuffleboard without having to implement
   * {@code Sendable}.
   */
  ...
  /**
   * Suppresses the log tab/layout corresponding to this {@link Loggable} instance
   * (or all instances
   * of the type).
   */
  @Retention(RetentionPolicy.RUNTIME)
